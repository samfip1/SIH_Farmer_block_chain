...
function App() {
  ...
  const [activePartnerTab, setActivePartnerTab] = useState('wholesalers');
      ...
      <aside className="sidebar">
        <div>
          <div className="sidebar-header sidebar-header-logo-group">
            ...
            <div className="sidebar-header-text">
              ...
              <div className="sidebar-subtitle">Retail Hub</div>
            </div>
          </div>
        ...
        <div className="sidebar-user-card">
          ...
          <div className="user-info">
            ...
            <div className="user-role">Premium Retailer</div>
          </div>
      ...
      <main className="main-content">
        <div className="topbar-row">
          <div className="header-section-inline">
            ...
            <div className="header-subtitle">Manage your agricultural retail business with ease</div>
          </div>
          ...
          <section>
            <div className="stats-section">
              <div className="stat-card">
                ...
                <span className="stat-icon orange"><i className="fas fa-shopping-cart"></i></span>
              </div>
              <div className="stat-card">
                <div>
                ...
                <span className="stat-icon orange"><i className="fas fa-truck"></i></span>
              </div>
              <div className="stat-card">
                <div>
              ...
              <div className="revenue-chart-container">
                ...
                <div className="chart-stats">
                  <div className="stat-item">
                    <div className="stat-value orange">+22.1%</div>
                    <div className="stat-label">GROWTH RATE</div>
                  </div>
                  <div className="stat-item">
                    <div className="stat-value orange">₹8.7M</div>
        ...
        {activeSection === 'partner' && (
          <section>
            ...
            <div className="partner-tabs">
              <div 
                className={`tab-item ${activePartnerTab === 'wholesalers' ? 'active' : ''}`}
                onClick={() => setActivePartnerTab('wholesalers')}
              >
                <i className="fas fa-warehouse"></i>
                Wholesalers
              </div>
              ...
              <div 
                className={`tab-item ${activePartnerTab === 'customers' ? 'active' : ''}`}
                onClick={() => setActivePartnerTab('customers')}
              >
